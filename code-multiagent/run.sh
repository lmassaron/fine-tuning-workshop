...
echo "====================================="
echo " Starting Coding Multi-Agent Pipeline"
echo "====================================="
...
echo "4. Installing Unsloth and HF Dependencies..."
pip install "unsloth[colab-new] @ git+https://github.com/unslothai/unsloth.git"
pip install transformers accelerate bitsandbytes peft datasets trl xformers
